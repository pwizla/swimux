Swimux is a complete rewrite of my [Swimo](github.com/pwizla/swimo) budget web app, using the three main [Redux](http://redux.js.org/) principles (single source of truth, no mutations, pure functions).
